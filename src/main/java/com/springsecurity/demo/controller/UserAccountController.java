...
import com.springsecurity.demo.repository.ConfirmationTokenRepository;
...
public class UserAccountController {
	...
	public ModelAndView registerUser(ModelAndView modelAndView, User user)
	{
		...
		else 
		{
			...
			mailMessage.setSubject("AccountZilla2 - Complete Registration!");
			mailMessage.setFrom("test.mail.sender20@gmail.com");
